...
class LiveScoreboard:
    def __init__(self):
        ...
        while appLive:
            ...
            # Update the day/time panel
            timePanel.setTime(now)
            timePanelSurface = timePanel.update()
            
            # Request weather data
            if(executionTime >= lastWeatherQueryTime + weatherQueryCooldown):
            ...
            # TODO: why is this blit not displaying anything??
...
class TimePanel:
    ...
    def update(self):
        ...
        # 1st line of text
        textSurface = self.font.render(string1, True, (0xBC, 0xBC, 0xBC))
        self.surface.blit(textSurface, ((self.surface.get_width() - textSurface.get_width()) // 2, int(self.surface.get_height() * 0.1)))

        textSurface = self.font.render(string2, True, (0xBC, 0xBC, 0xBC))
        self.surface.blit(textSurface, ((self.surface.get_width() - textSurface.get_width()) // 2, int(self.surface.get_height() * (0.1 + 0.35 + 0.1))))
